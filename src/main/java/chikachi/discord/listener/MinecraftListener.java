...
public class MinecraftListener {
    ...
    public void onCommand(CommandEvent event) {
        ...
        if (commandName.equalsIgnoreCase("say") || commandName.equalsIgnoreCase("me")) {
            ...
            if (sender != null) {
                Entity entity = sender.getEntityWorld()
                ...
                if (entity != null) {
                    ...
                    if (dimensionConfig.chatPrefix != null && dimensionConfig.chatPrefix.trim()
                        .length() > 0) {
            ...
            if (sender != null) {
                ...
                if (sender instanceof EntityPlayer) {
                    ...
                    Long discordId = Configuration.getLinking()
                        .getDiscordId(
                            ((EntityPlayer) sender).getGameProfile()
                                .getId());
                    if (discordId != null) {
                        User discordUser = DiscordClient.getInstance()
                            .getUser(discordId);
                        if (discordUser != null) {
            ...
            DiscordClient.getInstance()
                .broadcast(
                    new Message().setAuthor(authorName)
        ...
        DiscordClient.getInstance()
            .broadcast(
                new Message().setAuthor(authorName)
                    ...
                    .setArguments(arguments)
                    .setPrefix(
                        dimensionConfig.chatPrefix != null && dimensionConfig.chatPrefix.trim()
                            .length() > 0 ? dimensionConfig.chatPrefix : genericConfig.chatPrefix),
        ...
        if (entityPlayer != null && entityPlayer instanceof EntityPlayerMP) {
            ...
            arguments.put(
                ...
                achievement.func_150951_e()
                    .getUnformattedText());
            arguments
                .put("DESCRIPTION", StatCollector.translateToLocalFormatted(achievement.achievementDescription, "KEY"));
            ...
            DiscordClient.getInstance()
                .broadcast(
                    ...
                    dimensionConfig.relayAchievements.getChannels(
                        genericConfig.relayAchievements
                            .getChannels(dimensionConfig.discordChannel.getChannels(genericConfig.discordChannel))));
        }
    }
        ...
        DiscordClient.getInstance()
            .broadcast(
                ...
                dimensionConfig.relayPlayerLeave.getChannels(
                    genericConfig.relayPlayerLeave
                        .getChannels(dimensionConfig.discordChannel.getChannels(genericConfig.discordChannel))));
    }
    ...
    public void onPlayerDeath(LivingDeathEvent event) {
        ...
        if (entityLiving instanceof EntityPlayer) {
            ...
            arguments.put(
                "REASON",
                entityPlayer.func_110142_aN()
                    .func_151521_b()
                    .getUnformattedText()
                    .replace(entityPlayer.getDisplayName(), "")
                    .trim());
            ...
            DiscordClient.getInstance()
                .broadcast(
                    ...
                    dimensionConfig.relayPlayerDeath.getChannels(
                        genericConfig.relayPlayerDeath
                            .getChannels(dimensionConfig.discordChannel.getChannels(genericConfig.discordChannel))));
        }
    }
}

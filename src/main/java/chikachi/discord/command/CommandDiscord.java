...
public class CommandDiscord extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        String commandName = argsList.remove(0)
            .toLowerCase();
        UUID minecraftUUID;
        ...
        switch (commandName) {
            ...
            case "link":
                ...
                minecraftUUID = ((EntityPlayer) sender).getGameProfile()
                    .getId();
                ...
                if (requestOptional.isPresent()) {
                    ...
                    if (request.hasExpired()) {
                        sender.addChatMessage(
                            new ChatComponentText(MinecraftFormattingCodes.DARK_RED + "Linking request has expired"));
                        break;
                    }
            ...
            case "unlink":
                ...
                if (Configuration.getLinking()
                    .getDiscordId(minecraftUUID) == null) {
                    sender
                        .addChatMessage(new ChatComponentText(MinecraftFormattingCodes.DARK_RED + "You aren't linked"));
                    break;
                }
